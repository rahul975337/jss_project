...
class _BottomNavState extends State<BottomNav>
  ...
  _buildNavigationBottomNav() {
    var BottomNavs = <Widget>[];
    for (int i = 0; i < widget.items.length; i++) {
      BottomNavs.add(
        InkWell(
          ...
          child: LampNavigationBarBottomNav(
            key: UniqueKey(),
            icon: widget.items[i],
      ...
      child: Stack(
        children: <Widget>[
          AnimatedBuilder(
            ...
            builder: (_, w) {
              return Container(
                ...
                width: width,
                child: CustomPaint(
                  foregroundPainter: _SelectedBottomNavPainter(
          ...
          Row(
            ...
            children: <Widget>[..._buildNavigationBottomNav()],
          )
        ],
      ),
    );
...
class LampNavigationBarBottomNav extends StatelessWidget {
  final IconData icon;
...
class _SelectedBottomNavPainter extends CustomPainter {
  _SelectedBottomNavPainter({
    this.oldPosition,
    this.newPosition,
    this.progress,
    this.count,
  ...
  @override
  bool shouldRepaint(_SelectedBottomNavPainter oldDelegate) => true;
}
